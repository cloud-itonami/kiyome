(ns kiyome.methods.social
  "social.cljc — kiyome DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from kiyome's own
...
(defn draft-observation-post
  "A dry-run observation post over kiyome's own domain (Domestic / janitorial cleaning robotics — frees the invisible, gendered, dignity-poor cleaning labour (ISIC T,N81 / ISCO 9111,9112 / UNSPSC…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "kiyome R0: live social posting is Council Lv6+ + operator + "
